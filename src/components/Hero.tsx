...
const Hero = () => {
  ...
  useEffect(() => {
    const low = /Android|iPhone/i.test(navigator.userAgent) && navigator.hardwareConcurrency <= 4;
    setIsLowEndDevice(low);
  }, []);
  ...
  return (
    <section
      ...
      className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20"
    >
      {/* ✅ Render Prism only on capable devices */}
      {!isLowEndDevice && (
        <div className="absolute inset-0 -z-10">
          <Prism
            animationType="rotate"
            ...
            hueShift={0}
            colorFrequency={1}
            noise={isMobile ? 0.02 : 0.05}
            glow={isMobile ? 0.3 : 0.6}
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Software Engineer with 2+ years of experience in web and application development.
            Skilled in JavaScript, React.js, Node.js, MongoDB, and API integration, with proven
            success in boosting performance, SEO optimization, and delivering client-focused
            solutions.
          </motion.p>
